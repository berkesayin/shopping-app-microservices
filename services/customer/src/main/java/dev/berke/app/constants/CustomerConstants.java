...
public class CustomerConstants {
    ...
    public static final String CUSTOMER_FIRSTNAME_REQUIRED = "Customer first name is required";
    public static final String CUSTOMER_LASTNAME_REQUIRED = "Customer last name is required";
